...
module.exports = function(app){
	...
	app.post('/test/add', auth.authenticateRequest, test.addQuestionToTest);

	app.post('test/request' auth.authenticateRequest, test.addRequest);
	app.get('test/request' auth.authenticateRequest, test.getRequest);
	app.put('test/request' auth.authenticateRequest, test.acceptRequest);
	app.delete('test/request' auth.authenticateRequest, test.deleteRequest);
};